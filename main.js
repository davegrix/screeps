...
module.exports.loop = function () {
    ...
    rooms.forEach(function (room) {
        ...
        console.log("room " + room.name + " energy=" + room.energyAvailable + "  @  " + room.controller.progress + '/' + room.controller.progressTotal + ' ' + per.toFixed(2) + '%');
    });
    ...
    reserve.run();
    //claim.run();
    //r_W53N87.run(Game.rooms['W53N87']);
    //r_W52N87.run(Game.rooms['W52N87']);
    //r_W53N86.run(Game.rooms['W53N86']);
